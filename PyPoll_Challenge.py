...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if county_name not in counties_list:
            ...
            counties_vote[county_name] = 0
        # 5: Add a vote to that county's vote count.
        counties_vote[county_name] += 1
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in counties_list:
        ...
        county_vote = counties_vote.get(county)
        ...
        if(county_vote > county_votes_turnout) and (county_vote_percentage > county_percentage):
            county_votes_turnout = county_vote
            county_list_turnout = county
            county_percentage = county_vote_percentage

    # 7: Print the county with the largest turnout to the terminal.
    winning_county_print = (
        f"-----------------------\n"
        f"Largest County Turnout: {county_list_turnout}\n"
        f"-----------------------\n"
    )
